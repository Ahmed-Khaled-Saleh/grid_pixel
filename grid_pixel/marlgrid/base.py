...
# %% auto 0
__all__ = ['TILE_PIXELS', 'ObjectRegistry', 'rotate_grid', 'MultiGrid', 'MultiGridEnv', 'get_goal_observation_before_reaching']
...
class MultiGridEnv(gym.Env):
    ...
    def render(
        ...
        if mode == 'human' and not self.window:
            from grid_pixel.marlgrid.rendering import SimpleImageViewer
