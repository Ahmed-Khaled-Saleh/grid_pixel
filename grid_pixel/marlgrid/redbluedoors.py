"""Basic scenario where agents need to find and reach a goal in the grid world while navigating through red and blue doors."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/00i_marl_grid.redbluedoors.ipynb.

# %% auto 0
__all__ = ['RedBlueDoorsMarlGrid']

# %% ../../nbs/00i_marl_grid.redbluedoors.ipynb 3
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/00i_marl_grid.redbluedoors.ipynb 4
import numpy as np

from .base import MarlGridEnv, MarlGrid
from .objects import FreeDoor


# %% ../../nbs/00i_marl_grid.redbluedoors.ipynb 5
class RedBlueDoorsMarlGrid(MarlGridEnv):
    """
    ...
    def __init__(self, config):
        ...
        super(RedBlueDoorsMarlGrid, self).__init__(config, width, height)
    ...
    def reset(self):
        obs_dict = MarlGridEnv.reset(self)
    ...
    def step(self, action_dict):
        ...
        obs_dict, _, _, info_dict = MarlGridEnv.step(self, action_dict)
